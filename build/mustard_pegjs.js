  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_elementContents() {
        ...
        reportMatchFailures = false;
        var savedPos4 = pos;
        var result15 = parse_textElement();
        var result16 = result15 !== null
          ? (function(contentString) { return [contentString]; })(result15)
          : null;
        if (result16 !== null) {
        ...
        if (result14 !== null) {
          ...
          if (result11 !== null) {
            ...
            if (result4 !== null) {
              ...
              var result3 = result2 !== null
                ? (function(statement) { return [statement] })(result2)
                : null;
              if (result3 !== null) {
                var result1 = result3;
              } else {
      ...
      function parse_elementPrototype() {
        ...
        var result2 = result1 !== null
          ? (function(it, ct) { return {type:'proto', name:it, contents:ct} })(result1[0], result1[4])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_interpolateInternal() {
        ...
        var result12 = result11 !== null
          ? (function(id) { return {interpolate: id} })(result11[2])
          : null;
        if (result12 !== null) {
        ...
        if (result10 !== null) {
          ...
          var result3 = result2 !== null
            ? (function(id) { return {attribute_interpolate: id} })(result2[3])
            : null;
          if (result3 !== null) {
            var result1 = result3;
          } else {
