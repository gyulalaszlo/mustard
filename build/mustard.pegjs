  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_statement() {
        ...
        var savedPos1 = pos;
        var savedPos2 = pos;
        var result7 = parse_elementDeclaration();
        if (result7 !== null) {
          var result8 = parse__();
          if (result8 !== null) {
            var result11 = parse_elementContents();
        ...
        if (result4 !== null) {
          ...
          var savedPos0 = pos;
          var result2 = parse_textElement();
          var result3 = result2 !== null
            ? (function(text) { return text })(result2)
            : null;
          if (result3 !== null) {
            var result1 = result3;
          } else {
      ...
      function parse_stringLiteral() {
        ...
        if (result14 !== null) {
          ...
          if (result6 !== null) {
            ...
            var savedPos0 = pos;
            var savedPos1 = pos;
            var result4 = parse_interpolateInternal();
            if (result4 !== null) {
              var result5 = parse__();
              if (result5 !== null) {
